...
public class Data {
    ...
    static {
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(18), "media/cards/agua_santa.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(35), "media/cards/baronesa.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(11), "media/cards/bento_ribeiro.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(19), "media/cards/borda_do_mato.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(39), "media/cards/dona_marta.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(2), "media/cards/gardenia_azul.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(21), "media/cards/higienopolis.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(29), "media/cards/nova_esperanca.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(25), "media/cards/parque_uniao.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(33), "media/cards/providencia.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(28), "media/cards/sao_carlos.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(8), "media/cards/serrinha.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(15), "media/cards/tomas_coelho.png"));
        deck_init.add(new Card(Card.TYPE_CIRCLE, favelas.get(40), "media/cards/vidigal.png"));

        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(38), "media/cards/cantagalo.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(12), "media/cards/honorio_gurgel.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(20), "media/cards/jacarezinho.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(30), "media/cards/mangueira.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(34), "media/cards/morro_da_coroa.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(7), "media/cards/morro_do_fuba.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(14), "media/cards/morro_do_juramento.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(26), "media/cards/nova_holanda.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(27), "media/cards/oswaldo_cruz.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(36), "media/cards/pavao_pavaozinho.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(1), "media/cards/rio_das_pedras.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(9), "media/cards/rocha_miranda.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(27), "media/cards/vila_arara.png"));
        deck_init.add(new Card(Card.TYPE_TRIANGLE, favelas.get(13), "media/cards/vila_eugenia.png"));

        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(37), "media/cards/chapeu_mangueira.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(5), "media/cards/covanca.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(6), "media/cards/jardim_sulacap.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(32), "media/cards/mineira.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(22), "media/cards/morro_do_borel.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(17), "media/cards/morro_do_trajano.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(23), "media/cards/morro_dos_macacos.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(4), "media/cards/nova_aurora.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(41), "media/cards/rocinha.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(31), "media/cards/salgueiro.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(16), "media/cards/vila_cruzeiro.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(24), "media/cards/vila_do_joao.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(10), "media/cards/vila_santa.png"));
        deck_init.add(new Card(Card.TYPE_SQUARE, favelas.get(3), "media/cards/cidade_de_deus.png"));
    }
}